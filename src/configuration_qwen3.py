...
class Qwen3Config(PretrainedConfig):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.fineweb_bins = fineweb_bins
        self.checkpointing_threshold = checkpointing_threshold
        self.local_window_size = local_window_size
        self.g_inputs = g_inputs
        self.g_act_fn = g_act_fn
        self.g_expand = g_expand
        ...
        self.use_quest = use_quest
        self.quest_token_budget = quest_token_budget
